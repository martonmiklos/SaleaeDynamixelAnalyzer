...
static const uint8_t s_dxl_packets[] = {
	// First byte is count... 
	...
	0x30,0xff, 0xff, 0xfe, 0x2c, 0x83, 0x18, 0x01, 0x08, 0x00, 0x0e, 0x00, 0x02, 0x00, 0x07, 0x00, 0x0d,
...
void DynamixelSimulationDataGenerator::CreateSerialByte()
{
    ...
    uint8_t byte = s_dxl_packets[ mStringIndex ];
	mStringIndex++;
	mPacketIndex--;
